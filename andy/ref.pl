  ...
  'formats' => {
    ...
    'bcr' => {
      ...
      'options' => {
        ...
        'radius' => {
          'min'  => '',
          'desc' => 'Radius of our big earth (default 6371000 meters)',
          'max'  => '',
          'default' => '6371000',
          'type'    => 'float'
        },
    ...
    'kml' => {
      ...
      'options' => {
        ...
        'floating' => {
          'min'  => '',
          'desc' => 'Altitudes are absolute and not clamped to ground',
          'max'  => '',
          'default' => '',
          'type'    => 'boolean'
        },
  ...
  'filters' => {
    ...
    'track' => {
      'options' => {
        ...
        'name' => {
          'desc'  => 'Use only track(s) where title matches given name',
          'type'  => 'string',
          'valid' => []
        },
        'merge' => {
